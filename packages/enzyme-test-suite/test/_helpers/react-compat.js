...
let { createFactory } = require('react');
...
if (process.env.PREACT) {
  ...
  createFactory = preact.createFactory;
  renderToString = require('preact-render-to-string');
  createPortal = preact.createPortal;
  createContext = preact.createContext;
  createRef = preact.createRef;
  createRoot = null;
  forwardRef = preact.forwardRef;
  Fragment = preact.Fragment;
  StrictMode = preact.StrictMode;
  AsyncMode = null;
  ConcurrentMode = null;
  Profiler = null;
  PureComponent = preact.PureComponent;
  Suspense = preact.Suspense;
  lazy = preact.lazy;
  memo = preact.memo;
  useCallback = preact.useCallback;
  useContext = preact.useContext;
  useDebugValue = preact.useDebugValue;
  useEffect = preact.useEffect;
  useImperativeHandle = preact.useImperativeHandle;
  useLayoutEffect = preact.useLayoutEffect;
